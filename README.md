...
Dynamic filetring and sorting of the tables is availble after rigth clicking table's column.
Application was tested on a database with 10 000 entries and worked acceptably well, 
but on larger databases a performance bottleneck might be present as the application is single threaded.
